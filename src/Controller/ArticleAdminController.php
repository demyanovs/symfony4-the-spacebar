...
class ArticleAdminController extends AbstractController
{
    ...
    public function new(EntityManagerInterface $em)
    {
        $article = new Article();
        $article
            ->setTitle('Why do Asteroids Taste Like Bacon')
            ->setSlug('why-asteroids-'.rand(100, 999)   )
            ->setContent(<<<EOF
